...
7.5. Each grade can be from zero to ten, always with one digit after the decimal point. 
...
Print the message "MEDIA"(average in Portuguese) and the student's average according to the following 
example, with 5 digits after the decimal point and with a blank space before and after the equal 
signal.
