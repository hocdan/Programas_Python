...
class App():
    ...
    def draw(self):
        ...
        if (rodada%2 == 0):
            pyxel.text(menu[0]+50, menu[1]+10, "TURNO DO JOGADOR X", pyxel.COLOR_PEACH)
        else:
            pyxel.text(menu[0]+50, menu[1]+10, "TURNO DO JOGADOR O", pyxel.COLOR_PEACH)
        pyxel.text(menu[0]+10, menu[1]+50, "X: {}".format(pontosX), pyxel.COLOR_PEACH)
        pyxel.text(menu[0]+10, menu[1]+100, "O: {}".format(pontosO), pyxel.COLOR_PEACH)
        if (vencedorAtual == 1):
            pyxel.text(menu[0]+50, menu[1]+150, "VITORIA DO JOGADOR X!", pyxel.COLOR_PEACH)
        elif (vencedorAtual == 2):
            pyxel.text(menu[0]+50, menu[1]+150, "VITORIA DO JOGADOR O!", pyxel.COLOR_PEACH)
        elif (vencedorAtual == 3):
            pyxel.text(menu[0]+50, menu[1]+150, "DEU VELHA!", pyxel.COLOR_PEACH)
        else:
